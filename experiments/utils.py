class Registry:
    ...
    def register_dataset(cls):
        ...
        def wrap(dataset_cls):
            from experiments.datasets import BaseDataset
    ...
    def register_metrics(cls):
        ...
        def wrap(metrics_cls):
            from experiments.methods import BaseDatasetMetrics, BasePerSampleMetrics
    ...
    def register_process(cls):
        ...
        def wrap(process_cls):
            from experiments.methods import BaseProcess
    ...
    def register_method(cls):
        ...
        def wrap(method_cls):
            from experiments.methods import BaseMethod
